...
def caesar_cipher(message, shift):
    ...
    for char in message:
        if char == " ":
            ...
            encrypted_message += (chr((ord(upper_char) - ord('A') + shift) % 26 + ord('A')))
        else: encrypted_message += char
